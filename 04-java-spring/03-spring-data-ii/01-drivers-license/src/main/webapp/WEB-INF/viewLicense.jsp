...
<h1> ${license.person.firstName} ${license.person.lastName }</h1>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input class="form-control" value="${license.getNumberAsString() }">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input class="form-control" value="${license.state}">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input class="form-control" value="${license.expiration_date }">
    </div>
  </div>
