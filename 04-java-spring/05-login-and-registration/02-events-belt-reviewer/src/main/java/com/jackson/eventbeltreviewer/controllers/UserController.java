...
import com.jackson.eventbeltreviewer.validators.UserValidator;
...
public class UserController {
	...
	@PostMapping("/")
	public String Register(@Valid @ModelAttribute("registration") EventUser user, BindingResult result,
			HttpSession session) {
