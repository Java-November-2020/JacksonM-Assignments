package com.jackson.eventbeltreviewer.controllers;
...
import com.jackson.eventbeltreviewer.models.Event;
import com.jackson.eventbeltreviewer.models.EventUser;
import com.jackson.eventbeltreviewer.models.State;
import com.jackson.eventbeltreviewer.services.EventService;
import com.jackson.eventbeltreviewer.services.UserService;
...
public class EventController {
	...
	public String Comment(@PathVariable("id") Long id, @RequestParam("comment") String comment,
			RedirectAttributes redirs, HttpSession session) {
		Long userId = this.userSessionId(session);
		if (userId == null)
			return "redirect:/";
		if (comment.equals("")) {
	...
	public String ManageAttendeees(@PathVariable("id") Long id, @PathVariable("choice") String choice,
			HttpSession session) {
		Long userId = this.userSessionId(session);
		Event event = this.eService.findById(id);
